# Generated by Django 5.0 on 2023-12-31 00:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ManyToManyField(through='crud.Enrollment', to='crud.course')),
            ],
            bases=('crud.user',),
        ),
        migrations.AddField(
            ...
            name='learner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crud.learner'),
        ),
        migrations.AddField(
            model_name='course',
            name='learners',
